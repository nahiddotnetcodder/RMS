...
namespace RMS.Controllers
{
    ...
    public class HREmpSalaryController : Controller
    {
        ...
        public IActionResult Create(HREmpSalary hrempsalary)
        {
            ...
            try
            {
                if (_empSalary.IsDNameExists(hrempsalary.HREDId) == true)
                    errMessage = errMessage + " " + " Employee Name " + hrempsalary.HREDId + " Exists Already";
                if (errMessage == "")
                {
            ...
            {
                TempData["SuccessMessage"] = "Employee Profile " + hrempsalary.HRSId + " Created Successfully";
        ...
        public IActionResult Edit(HREmpSalary hrempsalary)
        {
            ...
            try
            {
                ...
                if (errMessage == "")
                {
                    ...
                    TempData["SuccessMessage"] = hrempsalary.HRSId + ",  Employee Profile Updated Successfully";
                    bolret = true;
                }
            }
            catch (Exception ex)
        ...
        {
            bool isExists = _empSalary.IsDNameExists(name,id);
