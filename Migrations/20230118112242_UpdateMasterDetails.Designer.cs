...
namespace RMS.Migrations
{
    ...
    [Migration("20230118112242_UpdateMasterDetails")]
    partial class UpdateMasterDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Models.HREmpDetails", b =>
                {
                    ...
                    b.Property<int?>("HREmpAttHREAId")
                        .HasColumnType("int");

                    b.Property<int?>("HREmpRoasterHRERId")
                        .HasColumnType("int");

                    b.Property<int?>("HREmpSalaryHRSId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HREmpAttHREAId");

                    b.HasIndex("HREmpRoasterHRERId");

                    b.HasIndex("HREmpSalaryHRSId");
            ...
            modelBuilder.Entity("RMS.Models.StoreGReceive", b =>
                {
                    b.Property<int>("GRId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("GRQty")
                        .HasColumnType("real");

                    b.Property<string>("GRRemarks")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<int>("GRTPrice")
                        .HasColumnType("int");

                    b.Property<float>("GRUPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("RMS.Models.AccGlTrans", b =>
                {
                    b.HasOne("RMS.Models.AccJournal", "AccTrNos")
                        .WithMany("AccGlTrans")
                        .HasForeignKey("AJTrNo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AccTrNos");
                });
            ...
            modelBuilder.Entity("RMS.Models.HREmpDetails", b =>
                {
                    ...
                    b.HasOne("RMS.Models.HREmpAtt", null)
                        .WithMany("HREDEName")
                        .HasForeignKey("HREmpAttHREAId");

                    b.HasOne("RMS.Models.HREmpRoaster", null)
                        .WithMany("HREDEName")
                        .HasForeignKey("HREmpRoasterHRERId");

                    b.HasOne("RMS.Models.HREmpSalary", null)
                        .WithMany("HREDEName")
                        .HasForeignKey("HREmpSalaryHRSId");
            ...
            modelBuilder.Entity("RMS.Models.StoreGoodsStock", b =>
                {
                    b.HasOne("RMS.Models.StoreIGen", "StoreIGens")
                        .WithMany()
                        .HasForeignKey("SIGId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StoreIGens");
                });
